            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style='cursor: pointer' wire:click="sort('clinic_price')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'clinic_price') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'clinic_price') fa-sort-amount-up ml-2 @endif'></i> المستشفى من العيادة الأستشارية </td>
                        <td style='cursor: pointer' wire:click="sort('doctor_price')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'doctor_price') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'doctor_price') fa-sort-amount-up ml-2 @endif'></i> الطبيب من العيادة الأستشارية</td>
                        <td style='cursor: pointer' wire:click="sort('doctor_id')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'doctor_id') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'doctor_id') fa-sort-amount-up ml-2 @endif'></i> الطبيب </td>
