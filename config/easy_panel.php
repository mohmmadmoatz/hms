...
return [
    ...
    'actions' => ["user","clinic","patient","checkup",'operation','stock','stockoperation','rays','sonar','room','payments','warehouse','setting',"warehouseexport","warehouseitem",'operationhold','stage','bank',"lab","labsetting","labtest","labcategory",'followup',"unit","fdebitcategory","fdebittransaction","debitaccount","debittransaction","saveaccount",'employee','empadvance','salary'],
];
